...
pub const POSITIVE_COLOUR: Colour = Colour::new(0x009800);
pub const NEGATIVE_COLOUR: Colour = Colour::new(0xD64848);
pub const EDIT_COLOUR: Colour = Colour::new(0xFFAA00);
